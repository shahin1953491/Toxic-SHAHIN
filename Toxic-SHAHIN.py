...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : MD SHAHINUR RAHMAN             \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber(SHAHIN)          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/shahin1953491│".center(columns+9))
    print("│ \033[95mCoder  : I FUCK YOUR ATTITUDE               \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
